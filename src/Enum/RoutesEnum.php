...
enum RoutesEnum: string
{
    ...
    case app_project_illustrations = '/illustration';
    case app_project_illustrations_es = '/ilustracion';
    case app_project_illustrations_ca = '/il-lustracio';
    ...
    case app_contact_es = '/contacto';
    case app_contact_ca = '/contacte';
    case app_about_me = '/about-me';
    case app_about_me_es = '/sobre-mi';
    case app_about_me_ca = '/qui-soc';
    // backend
